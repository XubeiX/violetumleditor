...
public class XLineEdgeTest {
	...
	public void checkLableTest(String newValue, String expected) {
	...
	public void BenStyleTests(BentStyle newValue, BentStyle expected) {
	...
	public void getsAllNoExistingPointsSchouldBeNullPointerException() {
	...
	public void getNoExistingLineSchouldBeNullPointException() {
	...
	public void getConnectionPointsBetween2Class() {
		...
		c1.setLocation(new Point2D.Double(0, 0)); // domyœlna d³ugoœæ 100
													// wysokoœæ 60 z klasy
													// ClassNode
	...
	public void privateMethodReturnedPointsTest() {
		...
		try {
			Method privateMethod = classToTest.getMethod("getPointsForNodesOnDifferentLifeLines",
					new Class[] { ClassNodeMorph.class, ClassNodeMorph.class });
